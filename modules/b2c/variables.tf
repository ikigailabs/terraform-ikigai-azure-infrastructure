...
variable "active_directory_b2c_country_code" {
  description = "Country code for the ikigai Active Directory"
  type        = string
  default     = "US"
}

variable "active_directory_b2c_data_residency_location" {
  description = "Data residency location for the ikigai Active Directory"
  type        = string
  default     = "United States"
}

variable "active_directory_b2c_display_name" {
  description = "Display name for the ikigai Active Directory"
  type        = string
  default     = "ikigai-b2c-tenant"
}

variable "active_directory_b2c_domain_name" {
  description = "Domain anme for the ikigai Active Directory"
  type        = string
  default     = "ikigaiactivedirectory.onmicrosoft.com"
}

variable "active_directory_b2c_sku" {
  description = "SKU for the ikigai Active Directory"
  type        = string
  default     = "PremiumP1"
}
